...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of BeautifulTextField.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/BeautifulTextField'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Dmitry Utmanov' => 'utm4@mail.ru' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/BeautifulTextField.git', :tag => s.version.to_s }
